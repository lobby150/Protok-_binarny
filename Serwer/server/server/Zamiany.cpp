//___________________________ZAMIANY - CPP_______________________________//
#include"pch.h"
#include "Zamiany.h"

int from2to10(std::string z2na10_input) {
	int wynik10 = 0;
...
std::string from10to2(int z10na2_input) {
	if (z10na2_input == 0) {
		return "00000000";
	}
	std::string wynik2 = "";
...
std::string fromCharto2(char z10na2_input) {
